...
The Katana emissions voting system distributes rewards to participants across the
ecosystem. Rewards come from several sources:
...
!!! info
    vKAT voters **direct** where KAT emissions go by voting on gauges, but the
    emissions themselves are claimed by those providing liquidity in those pools. 
    The rewards vKAT voters earn are vote incentives, trading fees, and exit fees.
