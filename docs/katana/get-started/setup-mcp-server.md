...
```bash
claude mcp add --transport http katana-mcp http https://mcp.katana.network/mcp
```
...
```bash
claude mcp add --transport http -s user katana-mcp http https://mcp.katana.network/mcp
```
